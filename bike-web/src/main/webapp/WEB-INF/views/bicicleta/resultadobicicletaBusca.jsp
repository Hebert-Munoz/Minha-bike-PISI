...
<ul class="list-group">
  <li class="list-group-item list-group-item">Banco : ${bicicleta.banco.nome}</li>
  <li class="list-group-item list-group-item">Guidão : ${bicicleta.guidao.nome}</li>
  <li class="list-group-item list-group-item">Cambio: ${bicicleta.cambio.nome}</li>
  <li class="list-group-item list-group-item">Quadro : ${bicicleta.quadro.nome}</li>
    <li class="list-group-item list-group-item">Rodas : ${bicicleta.rodas.nome}</li>
</ul>
